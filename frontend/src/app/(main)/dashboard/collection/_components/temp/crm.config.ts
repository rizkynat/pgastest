...
export const leadsBySourceChartData = [
  { source: "coll_3", leads: 10000000, fill: "var(--color-coll_3)" },
  { source: "coll_4", leads: 30000000, fill: "var(--color-coll_4)" },
  { source: "coll_5", leads: 60000000, fill: "var(--color-coll_5)" }
];
